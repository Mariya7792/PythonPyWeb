...
class TrainView(View):
    def get(self, request):
        ...
        max_articles = Entry.objects.aggregate(Count('id'))
        ...
        self.answer2 = Author.objects.get(author__)
        # Author.objects.filter('username').aggregate(max_age=Max('age'))
        ...
        self.answer10 = Entry.objects.annotate(count_articles=Count('id')).values('id', 'count_articles')
